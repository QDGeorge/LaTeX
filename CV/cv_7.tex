...
\familyname{Demianov} % Your last name

% All information in this block is optional, comment out any lines you don't need
\title{Curriculum Vitae}
\address{Address}{30 Pervomayaskaya st, Dolgoprudny, Russia}
\mobile{+7-(985) 157-4120}
\email{demyanov.gs@phystech.edu}
...
\extrainfo{DOB: the 26th of November, 1998}
...
\cventry{2016--...}{Moscow Institute of Physics and Technology}{}{Student of the Department of molecular and chemical physics (B.S.)}{field of study: Applied Mathematics and Physics}{Learned subjects:\\\underline{Mathematics:} ccalculus, analytic geometry, linear algebra\\
\underline{Physics:} general physics (mechanics, thermodynamics and molecular physics)\\
\underline{Chemistry:} organic and inorganic chemistry\\\underline{Other}: computer science, english language\\
Average Grade: 9.3/10; ranking top-10\%}


\section{Education and Training} % Дистанционное образование и дополнительные курсы (например, НМУ, курсы на edX/Coursera) стоит выносить в дополнительную графу, отдельную от графы с получением степени бакалавра/магистра — например, назвать подраздел не Education, а Education and Training и отдельным блоком указать эти курсы.
\cventry{August 2017}{<<Game theory>> by Moscow Institute of Physics and Technology on Coursera}{}{}{}{}
\cventry{August 2017}{<<Random graphs>> by Moscow Institute of Physics and Technology on Coursera}{}{}{}{}
...
\cventry{February 2016}{Diploma of the third degree of Olympiad of schoolchildren <<Phystech>>}{subject: physics}{}{}{}
\cventry{February 2016}{Diploma of the second degree of the <<Open chemical olympiad>>}{subject: chemistry}{}{}{}
\cventry{January 2016}{Prize-winner of the regional stage of the All-Russian Olympiad of Schoolchildren in Chemistry}{subject: chemistry}{}{}{}
\cventry{March 2015}{Diploma of the third degree of <<Moscow Olympiad of schoolchildren>>}{subject: chemistry}{}{}{}
...
\cvitem{Programming Languages}{\textsc{Python}}
%\cvitem{CAD}{\textsc{SOLIDWORKS}}
\cvitem{Software}{\textsc{Windows fluent user, LaTeX, Origin, MS Word, MS Excel, MS Power Point}}
...
%----------------------------------------------------------------------------------------
 ...
 %\renewcommand{\listitemsymbol}{-~} % Changes the symbol used for lists
 \cvlistdoubleitem{Playing the drum set}{}
 \cvlistitem{Football}
